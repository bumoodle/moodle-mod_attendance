...
$string['cannottake'] = 'You\'re not authorized to take attendance in this context.';
...
$string['configidnumberfields'] = 'The comma-separated shortnames of any custom user profile fields which represent ID numbers. Any field here can be used as concrete user identification for attendance import.';
$string['configuseidnumbers'] = 'If checked, the "ID Number" core user profile field should be used to represent an ID number, in addition to the fields below.';
...
$string['defaultstatus_included'] = 'Default Status';
$string['defaultstatus_included_help'] = 'The status which will be assigned to any student who is included in the import above, but whose mark has not been specified.';
$string['defaultstatus_omitted'] = 'Status for Missing';
$string['defaultstatus_omitted_help'] = 'The status which will be asssigned to any student who is in a session which has members included above, but who is not included in the list above. This option can be used to set up a system where a student is considered "absent" by omission.';
$string['defaulttime'] = 'Default Time';
$string['defaulttime_help'] = 'The date/time which will be assumed for any entry that does not contain a date/time pair. "Scan" time is used to identify which session the user is being marked present for.';
...
$string['idnumberfields'] = 'ID Number Fields';
$string['importsuccess'] = 'Successfully imported {$a} attendance record(s).';
$string['importerrors'] = '{$a} records could not be imported:';
$string['includeall'] = 'Select all sessions';
$string['includenottaken'] = 'Include not taken sessions';
$string['inclass'] = 'Attendance taken in class at ${a}.';
$string['indetail'] = 'In detail...';
$string['invalidimportformat'] = 'Invalid import format in the following line: <code>{$a}</code>.';
...
$string['userdata_help'] = 'User data can be entered in one of the following formats; with a single entry per row:
